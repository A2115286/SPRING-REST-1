...
public class Decorador implements IGestor {
	...
	ArrayList <uia.com.api.ContabilidadUIA.modelo.clientes.InfoUIA> lista = new ArrayList<InfoUIA>();
	...
	public ArrayList<InfoUIA> getLista() 
	{
		...
		if((lista.isEmpty()))
		{
			...
			{
				for (Map.Entry<String, uia.com.api.ContabilidadUIA.modelo.clientes.InfoUIA> p : this.gestor.getCatalogoMaestro().entrySet())
				{	
